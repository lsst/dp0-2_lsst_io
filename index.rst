...
.. Important::
    **New to DP0?** Welcome! See the :ref:`Delegate-Homepage-Getting-Started-Checklist`. Anyone with Rubin data rights may submit a request to participate in DP0 using `this form <https://forms.gle/hyZuXmc9S2ssTdW16>`_.
