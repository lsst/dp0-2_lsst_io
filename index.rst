...
DP0 delegates are the 600 Rubin Observatory data rights holders who have been given accounts in the
shared-risk early-development version of the RSP, through which they can access and analyze the DP0 data set.
Resources include a getting started checklist, recorded seminars, virtual events, and support.
...
The data set adopted for DP0 is the 300 deg\ :sup:`2` of simulated, LSST-like images and catalogs generated by the Dark Energy Science Collaboration (DESC) for their Data Challenge 2 (DC2; `arXiv:2010.05926 <https://arxiv.org/abs/2010.05926>`_).
...
The link below provides step-by-step instructions for RSP use.

During DP0, the RSP is in active development by Rubin Observatory staff, with access provided to delegates on a shared-risk basis.
All RSP users should review the page :ref:`Data-Access-Analysis-Tools-Warnings`.
