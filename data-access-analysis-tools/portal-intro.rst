...
Within each of these is the ability to use "UI assisted" searching or ADQL queries. 

There are multiple types of queries that can be performed in the Rubin Science Platform Portal Aspect
