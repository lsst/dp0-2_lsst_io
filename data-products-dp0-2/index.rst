...
**Truth catalog data** has become available via TAP and the Butler.
It is recommended to use the TAP service with table joins; see DP0.2 tutorial notebook number 8 for details.
