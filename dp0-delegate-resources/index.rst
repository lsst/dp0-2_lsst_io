...
| - first hour: live demo, beginner-level
| - second hour: delegate breakouts
|   -- will include a time-domain TAP notebook demo, intermediate-elvel
...
| - first hour: live demo, beginner-level
| - second hour: delegate breakouts
|   -- will include a time-domain Butler notebook demo, intermediate-elvel
